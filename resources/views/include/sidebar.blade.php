        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                <li class="{{ request()->is('pages/*') ? ' open' : '' }}">
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-bulb"></i><span class="sidebar-mini-hide">Barang</span></a>
                    <ul>
                        <li>
                            <a class="{{ request()->is('pages/datatables') ? ' active' : '' }}" href="{{route('barang')}}">barang</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('pages/slick') ? ' active' : '' }}" href="/pages/slick">Tambah Barang</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('pages/blank') ? ' active' : '' }}" href="/pages/blank">Hapus Semua Barang</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-main-heading">
                ...
                <li class="{{ request()->is('pages/*') ? ' open' : '' }}">
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-bulb"></i><span class="sidebar-mini-hide">Karyawan</span></a>
                    <ul>
                        <li>
                            <a class="{{ request()->is('pages/datatables') ? ' active' : '' }}" href="{{route('karyawan')}}">Karyawan</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('pages/slick') ? ' active' : '' }}" href="/pages/slick">Tambah Karyawan</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('pages/blank') ? ' active' : '' }}" href="/pages/blank">Hapus Semua Karyawan</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-main-heading">
