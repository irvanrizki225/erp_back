    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content block-content-full">
                ...
                @include('livewire.departemen.update')
                @if ($isModalOpen)
                @include('livewire.departemen.create')
                @endif
            </div>
            <div class="block-content block-content-full">
                    ...
                    <thead>
                        ...
                        <tr class="text-center">
                            ...
                            <td class="border px-4 py-2">
                                ...
                                wire:click="edit({{ $departemen->id }})" class="btn btn-primary">
                                    <i class="fa fa-pencil"></i>
                                </button>
                                <button wire:click="delete({{ $departemen->id }})" class="btn btn-danger">
