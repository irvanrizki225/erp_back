<div wire:ignore.self class="modal fade" id="item_barang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr class="text-center">
                                    <td class="border px-4 py-2"><input class="form-checkbox h-6 w-6 text-green-500" 
                                        wire:model="item_id" 
                                    ...
                                    <td class="border px-4 py-2">
                                        ...
                                        wire:model="quantity.{{ $item->id }}" placeholder="Enter Quantity">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="item()" class="btn btn-primary">Save changes</button>
            </div>
        </div>
    </div>
</div>